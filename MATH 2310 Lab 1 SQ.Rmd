...
```{r}
### Include appropriate code chunks for any calculations
```

Delete this and write, in complete sentences, summarizing your answer to the questions.
...
```{r}
### Use summary to answer this question
